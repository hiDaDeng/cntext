...
- [cntext: Text Analysis for Computational Social Science](#cntext-text-analysis-for-computational-social-science)
  - [Word Embedding Projection Approach (WEPA)](#word-embedding-projection-approach-wepa)
  - [Installation](#installation)
  - [Minimal Runnable WEPA Example](#minimal-runnable-wepa-example)
  - [WEPA Documentation and Reproducibility Files](#wepa-documentation-and-reproducibility-files)
  - [Quick Start](#quick-start)
  - [Module Overview](#module-overview)
  - [1. IO Module](#1-io-module)
    - [1.1 `get_dict_list()`](#11-get_dict_list)
    - [1.2 Built-in YAML Dictionaries](#12-built-in-yaml-dictionaries)
    - [1.3 `read_yaml_dict()`](#13-read_yaml_dict)
    ...
    - [1.13 `fix_contractions()`](#113-fix_contractions)
    - [1.14 `clean_text()`](#114-clean_text)
  - [2. Stats Module](#2-stats-module)
    ...
    - [2.9 Text Similarity](#29-text-similarity)
    - [2.10 `word_hhi()`](#210-word_hhi)
  - [3. Plot Module](#3-plot-module)
  ...
  - [4. Model Module](#4-model-module)
    ...
    - [4.8 Notes on Embedding Models](#48-notes-on-embedding-models)
    - [4.9 `expand_dictionary()`](#49-expand_dictionary)
  - [5. Mind Module](#5-mind-module)
    ...
    - [5.3 `wepa(wv, text, poswords, negwords, lang, cosine)`](#53-wepawv-text-poswords-negwords-lang-cosine)
    - [5.4 `project_text(wv, text, axis, lang, cosine)`](#54-project_textwv-text-axis-lang-cosine)
    - [5.5 `sematic_projection()`](#55-sematic_projection)
    - [5.6 `project_word()`](#56-project_word)
    - [5.7 `sematic_distance()`](#57-sematic_distance)
    - [5.8 `divergent_association_task()`](#58-divergent_association_task)
    - [5.9 `discursive_diversity_score()`](#59-discursive_diversity_score)
    - [5.10 `procrustes_align()`](#510-procrustes_align)
  - [6. LLM Module](#6-llm-module)
    - [6.1 `ct.llm()`](#61-ctllm)
    - [6.2 Built-in Prompts](#62-built-in-prompts)
  - [Anchor Dictionary Format for WEPA](#anchor-dictionary-format-for-wepa)
